...
export class SeatsService {
  constructor(
      ...
      @InjectModel(Theatre.name) private readonly theatreModel: Model<Seat>,
  ) {}
  ...
  getSeatsByTheatreId(theatreId: string): Promise<Seat[]> {
    return this.seatModel.find({ theatre: theatreId }).exec();
  }
}
