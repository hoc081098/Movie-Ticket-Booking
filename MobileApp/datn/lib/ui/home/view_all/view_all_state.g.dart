...
class _$ViewAllState extends ViewAllState {
  ...
  _$ViewAllState._(
      ...
      : super._() {
    if (page == null) {
      throw new BuiltValueNullFieldError('ViewAllState', 'page');
    }
    if (items == null) {
      throw new BuiltValueNullFieldError('ViewAllState', 'items');
    }
    if (isLoading == null) {
      throw new BuiltValueNullFieldError('ViewAllState', 'isLoading');
    }
    if (loadedAll == null) {
      throw new BuiltValueNullFieldError('ViewAllState', 'loadedAll');
    }
  }
