...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m9(msg) => "Lỗi khi đăng nhập Facebook: ${msg}";

  static m10(title) => "Loại bỏ không thành công: ${title}";

  static m11(title) => "Loại bỏ thành công: ${title}";

  static m12(msg) => "Đăng nhập Google không thành công: ${msg}";

  static m13(msg) => "Lỗi đăng nhập: ${msg}";

  static m14(message) => "Đăng xuất không thành công: ${message}";

  static m15(d) => "Đến: ${d}";

  static m16(d) => "Từ: ${d}";

  static m17(msg) => "Đăng ký lỗi: ${msg}";

  static m18(last4, msg) => "Xóa \'${last4}\' không thành công: ${msg}";

  static m19(last4) => "Xóa thành công: \'${last4}\'";

  static m20(msg) => "Đặt lại lỗi mật khẩu: ${msg}";

  static m21(seats) => "${Intl.plural(seats, other: 'ghế')}";

  static m22(last4) => "Đã chọn \'••••${last4}\'. Nhấn để thay đổi";

  static m23(message) => "Thêm/xoá yêu thích không thành công: ${message}";

  static m24(totalFavorite) => "${Intl.plural(totalFavorite, other: '${totalFavorite} yêu thích')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "createYourAccount" : MessageLookupByLibrary.simpleMessage("Tạo tài khoản"),
    ...
    "dontHaveAnAccountSignUp" : MessageLookupByLibrary.simpleMessage("Không có tài khoản? Đăng ký ngay"),
    ...
    "enterYourEmailToResetPassword" : MessageLookupByLibrary.simpleMessage("Nhập Email để đặt lại Mật khẩu"),
    ...
    "passwordMustBeAtLeast6Characters" : MessageLookupByLibrary.simpleMessage("Mật khẩu ít nhất 6 kí tự"),
    ...
    "registerError" : m17,
    "registerSuccessfullyPleaseCheckYourEmailInboxToVerifyThis" : MessageLookupByLibrary.simpleMessage("Đăng ký thành công. Vui lòng kiểm tra hộp thư email của bạn để xác minh tài khoản này."),
    ...
    "resetSuccessfullyPleaseCheckYourEmailToResetPassword" : MessageLookupByLibrary.simpleMessage("Thành công. Vui lòng kiểm tra email của bạn để đặt lại mật khẩu!"),
